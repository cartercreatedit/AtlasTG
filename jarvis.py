...
st.markdown(
    ...
    /* Remove the visible Streamlit component loading/fading bar */
...
.listening {
    animation: listening .8s infinite ease-in-out !important;
}
...
/* Tell Streamlit immediately that the page is ready. */
