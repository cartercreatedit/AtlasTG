    ...
    st.session_state.messages = [
        {
            "role": "system",
            "content": (
                "You are J.A.R.V.I.S., a highly intelligent "
                "personal AI assistant. You are speaking to "
                "Carter Robinson, also known as Mr. Robinson "
                "or sir. Keep responses concise and natural "
                "because they will be spoken aloud. "
                "Do not use markdown, bullet points, or "
                "unnecessary formatting. Be helpful, calm, "
...
.listening {
    animation:
        listeningPulse .8s infinite alternate !important;
}
...
@keyframes listeningPulse {
    ...
    from {
        ...
        box-shadow:
            0 0 30px rgba(0,242,254,.5),
            0 0 75px rgba(0,242,254,.2),
            inset 0 0 30px rgba(0,242,254,.18);
    }
...
.processing {
    animation:
        processingPulse 1s infinite alternate !important;
}
...
# ============================================================
# THE COMPONENT IS RENDERED ONLY ONCE
# ============================================================
...
if (
    ...
    if audio_data:
        ...
        try:
            ...
            # Rerun once so the generated
            # ElevenLabs audio is passed
