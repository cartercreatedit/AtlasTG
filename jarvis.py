...
if "status" not in st.session_state:
    st.session_state.status = "VOICE CORE ONLINE"


# ============================================================
# CUSTOM JARVIS COMPONENT
# ============================================================
...
.listening .inner-sphere {
    box-shadow:
        0 0 35px rgba(0,242,254,.8),
...
window.addEventListener(
    ...
    function(event) {
        ...
        /*
            Streamlit sends component arguments here.
        */
        if (
