...
if not eleven_key or not voice_id:
    st.error("Missing ElevenLabs credentials inside secrets.")
    st.stop()
...
<script>
    ...
    // Secure frame communication setup
    function sendPayloadToStreamlit(base64Data) {
            ...
            try {
                ...
                mediaRecorder.onstop = () => {
                    ...
                    reader.onloadend = () => {
                        ...
                        sendPayloadToStreamlit(base64String);
                    };
    ...
    try:
        ...
        if user_text:
            ...
            if eleven_key and voice_id:
                ...
                # Single-line audio string avoids python variable parsing conflicts completely
